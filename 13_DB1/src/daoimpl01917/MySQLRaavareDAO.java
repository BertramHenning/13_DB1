...
public class MySQLRaavareDAO implements RaavareDAO {
	...
	public void createRaavare(RaavareDTO raavare) throws DALException {
		Connector.doUpdate(
				"INSERT INTO raavare(raavareId, raavareNavn, Leverandoer) VALUES "+"("+raavare.getRaavareId()+", '"+raavare.getRaavareNavn()+"', '"+raavare.getLeverandoer()+"');");
	...
	public void updateRaavare(RaavareDTO raavare) throws DALException {
		Connector.doUpdate(
				"UPDATE raavare SET raavareNavn = '"+raavare.getRaavareNavn()+"', raavareId = '"+raavare.getRaavareId()+"', leverandoer = '"+raavare.getLeverandoer()+";");
